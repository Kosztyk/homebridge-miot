...
class XiaomiVacuumC108 extends RobotCleanerDevice {
  ...
  devicePropertiesToMonitor() {
    return ['vacuum:status', 'vacuum:fault', 'vacuum:common-params', 'vacuum:sweep-type', 'vacuum:suction-level',
      'vacuum:cleaning-area', 'vacuum:cleaning-time', 'vacuum:last-clean-time', 'vacuum:order-clean',
      'vacuum:sweep-break-switch', 'battery:battery-level', 'battery:charging-state', 'filter:filter-life-level',
      'filter:filter-left-time', 'brush-cleaner:brush-life-level', 'brush-cleaner:brush-left-time',
      'no-disturb:no-disturb', 'no-disturb:enable-time-period', 'clean-record:total-clean-area',
      'clean-record:total-clean-time', 'clean-record:total-clean-count', 'clean-record:clean-record',
      'notification:notification', 'lighting:lighting', 'time-zone-info:time-zone'
    ];
  }
