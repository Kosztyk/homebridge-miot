...
class AirPurifierAccessory extends BaseAccessory {
  ...
  initAccessoryObject() {
    ...
    this.airPurifierRefinedHomeKitView = this.getConfigValue('airPurifierRefinedHomeKitView', true);
  ...
  setupMainAccessoryService() {
    ...
    if (this.airPurifierRefinedHomeKitView) this.markPrimaryService(this.airPurifierService);
