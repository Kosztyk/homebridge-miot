...
- Keep robot vacuum accessories on the vacuum/robot-cleaner layout by default.
- Disable the experimental Fanv2 primary service for Jamal/robot vacuums unless `vacuumRefinedHomeKitView` is explicitly enabled.
- Keep the refined native AirPurifier primary service for real air purifier devices only.
